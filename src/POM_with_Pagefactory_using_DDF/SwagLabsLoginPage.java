...
public class SwagLabsLoginPage 
{
       //step1: declaration of variable
		@FindBy(xpath="//input[@type='text']")private WebElement UN;//->private WebElement UN=driver.findElement(By.xpath(""));  //early/basic  initialization 
	    @FindBy(xpath="//input[@id='password']")private WebElement PWD;//privateWebElement UN=driver.findElement(By.xpath("")); 
